...
from equipe.models import Capitao, Time
from equipe.serializer import CapitaoSerializer, TimeSerializer
...
class NegativeCapatainTestCases(APITestCase):
    ...
    def test_captain_miss_field(self):
        ...
        self.assertTrue(response.data, "Conteudo de criação incorreta para recurso")
...
class RetrieveCaptainsTestCases(APITestCase):
    ...
    def setUp(self):
        ...
        self.client.post(self.URL_CREATE, self.valid_payload, format="json")
